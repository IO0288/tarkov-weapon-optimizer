...
\begin{frame}{Acknowledgements}
    \begin{center}
        ...
        \vspace{0.3cm}
        \includegraphics[height=1cm]{logos/tarkov-dev-logo.png}
        ...
        \begin{tabular}{c @{\hspace{1cm}} c @{\hspace{1cm}} c}
            \includegraphics[height=1.2cm]{logos/claude-color.png} &
            \includegraphics[height=1.2cm]{logos/gemini-color.png} &
            \includegraphics[height=1.2cm]{logos/minimax-color.png} \\[0.3cm]
